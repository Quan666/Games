  ...
  return function (moduleArg = {}) {
    ...
    var B = Object.assign({}, moduleArg),
      ...
      oa =
        ...
        'object' == typeof process.Ma &&
        'string' == typeof process.Ma.node,
      D = C && 'em-pthread' == self.name
    B.Z || (B.Z = 0)
    B.Z++
    ;(() => {
        ...
        (function (b) {
          function c(l, n, u) {
            ...
            v.onprogress = function (h) {
              ...
              if (h.loaded) {
                v.m
                  ? (B.K[l].loaded = h.loaded)
                  : ((v.m = !0), B.K || (B.K = {}), (B.K[l] = { loaded: h.loaded, total: q }))
                var t = (q = h = 0),
                  A
                for (A in B.K) {
                  var J = B.K[A]
          ...
          'function' !== typeof B.locateFilePackage ||
            B.locateFile ||
            ((B.locateFile = B.locateFilePackage),
            E(
              'warning: you defined Module.locateFilePackage, that has been renamed to Module.locateFile (using your locateFilePackage for now)',
            ))
          var f = B.locateFile ? B.locateFile('pikafish.data', '') : 'pikafish.data',
            k = b.remote_package_size,
            p = null,
            w = B.getPreloadedPackage ? B.getPreloadedPackage(f, k) : null
          w ||
            c(
              f,
              k,
          ...
          files: [{ filename: '/pikafish.nnue', start: 0, end: 4134154 }],
          remote_package_size: 4134154,
        })
    })()
    ...
    var xa = B.print || console.log.bind(console),
      E = B.printErr || console.error.bind(console)
    Object.assign(B, qa)
    qa = null
          ...
          if ('load' === e) {
            ...
            'cancel' === e
              ...
              : 'setimmediate' !== d.target &&
                ('checkMailbox' === e
                  ? za && Ia()
                  : e && (E(`worker: received unknown command ${e}`), E(d)))
          }
        } catch (f) {
          throw (Ja(), f)
        }
      ...
      if (B.wasmMemory) {
        ...
        if (
          ((m = new WebAssembly.Memory({
            initial: (B.INITIAL_MEMORY || 67108864) / 65536,
            maximum: 19200,
            shared: !0,
          })),
    ...
    var ab = (a) => a.startsWith('data:application/octet-stream;base64,'),
      bb
    bb = 'pikafish.wasm'
    if (!ab(bb)) {
      var cb = bb
    ...
    function eb(a) {
      return Ka || (!na && !C) || 'function' != typeof fetch
        ? Promise.resolve().then(() => db(a))
    ...
    function Ba() {
      hb = {
        __pthread_create_js: ib,
        __syscall_fcntl64: jb,
        __syscall_ftruncate64: kb,
        __syscall_getcwd: lb,
        __syscall_ioctl: mb,
        __syscall_openat: nb,
        _emscripten_get_now_is_monotonic: ob,
        _emscripten_init_main_thread_js: pb,
        _emscripten_notify_mailbox_postmessage: qb,
        _emscripten_receive_on_main_thread_js: rb,
        _emscripten_thread_cleanup: sb,
        _emscripten_thread_mailbox_await: Da,
        _emscripten_thread_set_strongref: tb,
        _localtime_js: ub,
        _mktime_js: vb,
        _tzset_js: wb,
        abort: xb,
        emscripten_check_blocking_allowed: yb,
        emscripten_date_now: zb,
        emscripten_exit_with_live_runtime: Ab,
        emscripten_get_now: Bb,
        emscripten_num_logical_cores: Cb,
        emscripten_resize_heap: Db,
        environ_get: Eb,
        environ_sizes_get: Fb,
        exit: Gb,
        fd_close: Hb,
        fd_read: Ib,
        fd_seek: Jb,
        fd_write: Kb,
        memory: m || B.wasmMemory,
        strftime_l: Lb,
      }
      ...
      new Promise((b) => {
        a.onmessage = (f) => {
          ...
          if (f.targetThread && f.targetThread != Aa()) {
            ...
            p
              ? p.postMessage(f, f.transferList)
              : E(
                  `Internal error! Worker sent a message "${k}" to target pthread ${f.targetThread}, but that thread no longer exists!`,
                )
          } else {
            if ('checkMailbox' === k) {
              Ia()
    ...
    function Pb() {
      ...
      B.mainScriptUrlOrBlob &&
        ((a = B.mainScriptUrlOrBlob), 'string' != typeof a && (a = URL.createObjectURL(a)))
    ...
    var ib = (a, b, c, d) => {
      if ('undefined' == typeof SharedArrayBuffer) {
        return (
          E('Current environment does not support SharedArrayBuffer, pthreads are not available!'),
          6
        )
      }
      var e = []
    ...
    var kc = (a, b) => {
      ...
      qc = 'undefined' != typeof TextDecoder ? new TextDecoder('utf8') : void 0,
      rc = (a, b) => {
    ...
    function Cc(a, b) {
      ...
      c >= b ||
        ...
        0 < a.l && a.g.set(c.subarray(0, a.l), 0))
    }
    var R = {
        v: null,
        B() {
        ...
        createNode(a, b, c, d) {
          ...
          R.v ||
            (R.v = {
              ...
              link: { node: { F: R.h.F, s: R.h.s, R: R.h.R }, stream: {} },
              ga: { node: { F: R.h.F, s: R.h.s }, stream: Dc },
            })
          c = Ec(a, b, c, d)
          S(c.mode)
            ? ((c.h = R.v.dir.node), (c.i = R.v.dir.stream), (c.g = {}))
            : 32768 === (c.mode & 61440)
              ? ((c.h = R.v.file.node), (c.i = R.v.file.stream), (c.l = 0), (c.g = null))
              : 40960 === (c.mode & 61440)
                ? ((c.h = R.v.link.node), (c.i = R.v.link.stream))
                : 8192 === (c.mode & 61440) && ((c.h = R.v.ga.node), (c.i = R.v.ga.stream))
        ...
        i: {
          ...
          G(a, b, c) {
            1 === c
              ? (b += a.position)
              : 2 === c && 32768 === (a.node.mode & 61440) && (b += a.node.l)
            if (0 > b) {
              throw new Q(28)
            }
            return b
    ...
    function qd(a, b, c, d, e) {
      class f {
        ...
        ma() {
          ...
          var u = Number(n.getResponseHeader('Content-length')),
            v,
            h = (v = n.getResponseHeader('Accept-Ranges')) && 'bytes' === v
      ...
      try {
        ...
        switch (b) {
          ...
          case 21523:
            ...
            d.j.C.Aa &&
              ((f = [24, 80]), (e = O()), (ca()[e >> 1] = f[0]), (ca()[(e + 2) >> 1] = f[1]))
            return 0
          case 21524:
            return d.j ? 0 : -59
          case 21515:
    ...
    var ob = () => 1,
      ...
      Da = (a) => {
        'function' === typeof Atomics.Na &&
          (Atomics.Na(y(), a >> 2, a).value.then(Ia), (a += 128), Atomics.store(y(), a >> 2, 1))
      },
      Ia = () => {
        var a = Aa()
        if (a && (Da(a), (a = td), !Ma)) {
      ...
      qb = (a, b) => {
        a == b
          ...
          : D
            ...
            : (a = M[a]) && a.postMessage({ cmd: 'checkMailbox' })
      },
      ud = [],
      rb = (a, b, c, d, e) => {
        ud.length = d
      ...
      tb = () => {},
      wd = (a) => 0 === a % 4 && (0 !== a % 100 || 0 === a % 400),
      xd = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335],
      yd = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334]
    function ub(a, b, c) {
    ...
    function vb(a) {
      var b = new Date(
        ...
        k = Math.min(f, e)
      0 > c
        ? (y()[(a + 32) >> 2] = Number(e != f && k == d))
        : 0 < c != (k == d) &&
          ((e = Math.max(f, e)), b.setTime(b.getTime() + 6e4 * ((0 < c ? k : e) - d)))
      y()[(a + 24) >> 2] = b.getDay()
    ...
    var Cb = () => navigator.hardwareConcurrency,
      Db = (a) => {
        var b = aa().length
        a >>>= 0
        if (a <= b || 1258291200 < a) {
        ...
        for (var c = 1; 4 >= c; c *= 2) {
          ...
          a: {
            e =
              (e.min.call(e, 1258291200, d + ((65536 - (d % 65536)) % 65536)) -
                m.buffer.byteLength +
                65535) /
              65536
            try {
    ...
    var Dd = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31],
      ...
      Gd = (a, b, c, d) => {
        ...
        function k(h, q) {
          ...
          var A
          0 === (A = t(h.getFullYear() - q.getFullYear())) &&
            0 === (A = t(h.getMonth() - q.getMonth())) &&
            (A = t(h.getDate() - q.getDate()))
          return A
        }
        function p(h) {
          switch (h.getDay()) {
        ...
        function w(h) {
          ...
          for (h = new Date(new Date(h.J + 1900, 0, 1).getTime()); 0 < q; ) {
            var t = h.getMonth(),
              A = (wd(h.getFullYear()) ? Dd : Ed)[t]
            if (q > A - h.getDate()) {
              ;(q -= A - h.getDate() + 1),
                h.setDate(1),
                11 > t ? h.setMonth(t + 1) : (h.setMonth(0), h.setFullYear(h.getFullYear() + 1))
            } else {
        ...
        l = {
          '%a': (h) => u[h.A].substring(0, 3),
          '%A': (h) => u[h.A],
          '%b': (h) => v[h.X].substring(0, 3),
          '%B': (h) => v[h.X],
          '%C': (h) => f(((h.J + 1900) / 100) | 0, 2),
          '%d': (h) => f(h.ea, 2),
          '%e': (h) => e(h.ea, 2, ' '),
          '%g': (h) => w(h).toString().substring(2),
          '%G': w,
          '%H': (h) => f(h.W, 2),
          '%I': (h) => {
            h = h.W
          ...
          '%t': () => '\t',
          '%u': (h) => h.A || 7,
          '%U': (h) => f(Math.floor((h.I + 7 - h.A) / 7), 2),
          '%V': (h) => {
          ...
          '%w': (h) => h.A,
          '%W': (h) => f(Math.floor((h.I + 7 - ((h.A + 6) % 7)) / 7), 2),
          '%y': (h) => (h.J + 1900).toString().substring(2),
          '%Y': (h) => h.J + 1900,
          '%z': (h) => {
            h = h.Ga
            var q = 0 <= h
    ...
    B.FS_createDevice = X
    var vd = [Xb, $b, ic, jb, kb, lb, mb, nb, Eb, Fb, Hb, Ib, Jb, Kb],
      hb,
      Z = (function () {
        function a(c, d) {
          Z = c.exports
    ...
    var Aa = () => (Aa = Z.pthread_self)(),
      Ca = (a, b, c, d, e, f) => (Ca = Z._emscripten_thread_init)(a, b, c, d, e, f),
      Ja = () => (Ja = Z._emscripten_thread_crashed)(),
      Vb = (a, b, c, d, e) => (Vb = Z._emscripten_run_on_main_thread_js)(a, b, c, d, e),
      dc = (a) => (dc = Z._emscripten_thread_free_data)(a),
      Ha = (a) => (Ha = Z._emscripten_thread_exit)(a),
      td = () => (td = Z._emscripten_check_mailbox)(),
      zd = (a) => (zd = Z._emscripten_tempret_set)(a),
      fc = (a, b) => (fc = Z.emscripten_stack_set_limits)(a, b),
      Wb = (a) => (Wb = Z._emscripten_stack_restore)(a),
      Ub = (a) => (Ub = Z._emscripten_stack_alloc)(a),
      Tb = () => (Tb = Z.emscripten_stack_get_current)()
    ...
    B.dynCall_viijii = (a, b, c, d, e, f, k) =>
      (B.dynCall_viijii = Z.dynCall_viijii)(a, b, c, d, e, f, k)
    B.dynCall_iiiiij = (a, b, c, d, e, f, k) =>
      (B.dynCall_iiiiij = Z.dynCall_iiiiij)(a, b, c, d, e, f, k)
    B.dynCall_iiiiijj = (a, b, c, d, e, f, k, p, w) =>
      (B.dynCall_iiiiijj = Z.dynCall_iiiiijj)(a, b, c, d, e, f, k, p, w)
    B.dynCall_iiiiiijj = (a, b, c, d, e, f, k, p, w, l) =>
      (B.dynCall_iiiiiijj = Z.dynCall_iiiiiijj)(a, b, c, d, e, f, k, p, w, l)
...
if (typeof exports === 'object' && typeof module === 'object') module.exports = Pikafish
else if (typeof define === 'function' && define['amd']) define([], () => Pikafish)
